...
def prepare_agent():
    ...
    db = SQLDatabase.from_uri(snowflake_url,sample_rows_in_table_info=5, include_tables=['merchant','my_me_merchant_benchmark','my_peer_merchant_benchmark','my_region_merchant_benchmark'])
